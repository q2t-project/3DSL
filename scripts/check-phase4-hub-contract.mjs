// scripts/check-phase4-hub-contract.mjs
...
function fail(msg) {
  console.error("[phase4:hub-contract] FAIL:", msg);
  process.exit(1);
}
function ok(msg) {
  console.log("[phase4:hub-contract] OK:", msg);
}
function warn(msg) {
  console.warn("[phase4:hub-contract] WARN:", msg);
}
...
function main() {
  ...
  ok("Phase4 viewerHub boundary + loop contract looks consistent.");
}
