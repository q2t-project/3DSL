...
- /viewer?profile=devHarness_full&model=/3dss/fixtures/phase7/phase7_valid_center_visible.3dss.json
  - 起動して操作できる（orbit/zoom）
- /viewer?profile=devHarness_full&model=/3dss/fixtures/phase7/phase7_invalid_schema_missing_required.3dss.json
...
- valid_center_visible をロードした状態で console:
  ...
  - const r = await import("/viewer/test/phase7Runner.js");
  - await r.runAll(hub);
