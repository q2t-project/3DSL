// scripts/check/viewer-core-layer-contract.mjs
...
const ROOT = siteRoot;
function fail(msg) {
  console.error("[viewer-core-layer-contract] FAIL:", msg);
  process.exit(1);
}
function ok(msg) {
  console.log("[viewer-core-layer-contract] OK:", msg);
}
function warn(msg) {
  console.warn("[viewer-core-layer-contract] WARN:", msg);
}
...
function main() {
  ...
  ok("viewer core-layer contract looks consistent.");
}
