// scripts/check/viewer-bootstrap-flow-contract.mjs
...
const ROOT = siteRoot;
function fail(msg) {
  console.error("[viewer-bootstrap-flow-contract] FAIL:", msg);
  process.exit(1);
}
function ok(msg) {
  console.log("[viewer-bootstrap-flow-contract] OK:", msg);
}
function warn(msg) {
  console.warn("[viewer-bootstrap-flow-contract] WARN:", msg);
}
...
function main() {
  ...
  ok("viewer bootstrapViewer initialization flow contract looks consistent.");
}
