...
const ALLOWLIST = new Set([
  ...
  "apps/site/public/3dss/release/.gitkeep",
]);
const NO_MJS_DIRS = [
  "apps/site/public/viewer",
...
if (bad.length > 0) {
  ...
  console.error("  git rm -r --cached apps/site/public/viewer apps/site/public/vendor apps/site/public/3dss/release");
