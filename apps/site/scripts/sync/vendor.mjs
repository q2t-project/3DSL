...
// Provide a stable ESM entry for runtime importmaps.
// Ajv's "dist/ajv.js" is UMD, so it doesn't export ESM symbols. In the
// browser we can import it for side-effects (it attaches `Ajv` on
// `globalThis`) and then re-export that value.
await writeFile(
  path.resolve(dst, "ajv", "dist", "ajv.bundle.js"),
  [
    "// GENERATED by apps/site/scripts/sync/vendor.mjs (SSOT).",
    "// ESM wrapper for Ajv (UMD build).",
    'import "./ajv.js";',
