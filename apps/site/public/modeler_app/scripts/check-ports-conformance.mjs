...
// - Additionally, only ui/hubFacade.js may touch hub.core.* (hub.core is privileged controllers surface).
...
// If you add a new hub.core controllers field, update:
// - runtime/modelerHub.js (public surface)
// - manifest.yaml (hub.core.controllers surface description)
